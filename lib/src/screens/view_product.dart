...
class _ViewProductsState extends State<ViewProducts> {
  ...
  Widget buildListTileView() {
    return ListView.separated(
        ...
        itemCount: PetUtility().productList.length,
        itemBuilder: (context, index) {
          final products = PetUtility().productList[index];
          return Container(
            ...
            child: ListTile(
              ...
              trailing: !PetUtility().isAdmin
                  ? SizedBox()
                  : IconButton(
                      onPressed: () async {
                        PetUtility().showCustomHUD("Please wait...");
                        await _database
          ...
          builder: (context, AsyncSnapshot<Event> snap) {
            if (snap.hasData) {
              if (snap.data!.snapshot.value != null) {
                ...
                PetUtility().productList = products.values
                    .map((value) =>
            ...
            return Container(
                ...
                decoration: BoxDecoration(
                    ...
                    color: Theme.of(context)
                        ...
                        .secondary
                        .withOpacity(0.5)),
                child: PetUtility().productList.length > 0
                    ? buildListTileView()
                    : Center(
